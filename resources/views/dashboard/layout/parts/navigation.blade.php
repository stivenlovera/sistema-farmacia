<nav class="navbar ms-navbar">
    ...
    <div class="logo-sn logo-sm ms-d-block-sm">
      <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="index.html"><img src="{{ asset('img/descarga.png') }}" alt="logo"> </a>
    </div>
    <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
      ...
      <li class="ms-nav-item ms-nav-user dropdown">
        <a href="#" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img class="ms-user-img ms-img-round float-right" src="{{ asset('img/user.jpg') }}" alt="people"> </a>
        <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
          <li class="dropdown-menu-header">
            <h6 class="dropdown-header ms-inline m-0"><span class="text-disabled">Bienvenido, {{ auth()->user()->persona->nombre }} {{auth()->user()->persona->apellido}}</span></h6>
          </li>
          <li class="dropdown-divider"></li>
          <li class="ms-dropdown-list">
            <a class="media fs-14 p-2" href="{{ route('user.profile', ['id'=>auth()->user()->personaId]) }}"> <span><i class="flaticon-user mr-2"></i>Perfil</span> </a>
            ...
            <a class="media fs-14 p-2" href="pages/prebuilt-pages/user-profile.html"> <span><i class="flaticon-gear mr-2"></i>Configuracion</span> </a>
          </li>
          <li class="dropdown-divider"></li>
          ...
          <li class="dropdown-menu-footer">
                <a class="media fs-14 p-2" type="submit" href="{{ route('logout') }}"> <span><i class="flaticon-shut-down mr-2"></i> Cerrar Session</span> </a>  
          </li>
        </ul>
      </li>
    </ul>
